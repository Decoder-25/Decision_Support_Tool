...
export const OPTIONS: OptionCatalog = {
  ...
  networkSecurityExternal: [
    ...
    {
      value: "inDepthSystemInspection",
      label: "Indepth-System-Inspection",
      score: 9,
    },
  ],
  ...
  networkSecurityInternal: [
    ...
    { value: "trafficMonitoring", label: "traffic-monitoring", score: 7 },
    {
      value: "inDepthPacketInspection",
      label: "in-depth-packet-inspection",
      score: 9,
    },
  ],
  ...
  userEducation: [
    ...
    {
      value: "activeSimulatedSocialEngineeringAttacks",
      label: "Active Simualted Social Engineering Attacks",
      score: 7,
    },
    {
      value: "stronglyMonitoredPolicies",
      label: "Strongly Monitored Policies",
      score: 9,
    },
  ],
  ...
  processes: [
    ...
    {
      value: "promptDisablingWhenUsersLeave",
      label: "Prompt Disabling When the users leave",
      score: 9,
    },
  ],
  ...
  authentication: [
    ...
    {
      value: "regularlyChangedpassword",
      label: "Regularly-changed-password",
      score: 9,
    },
  ],
